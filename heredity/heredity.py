...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        # Determine the number of copies of the gene for this person.
        ...
        # Determine if the person exhibits the trait.
        has_trait = person in have_trait

        # If the person has no parental information, use the unconditional gene probability.
        mother = people[person]["mother"]
        father = people[person]["father"]
        if mother is None and father is None:
            gene_prob = PROBS["gene"][gene_count]
        else:
            # For each parent, calculate the probability they pass on the gene.
            # If a parent has 2 copies, they pass it on with probability 1 - mutation.
            # If a parent has 1 copy, there is a 50% chance.
            # If a parent has 0 copies, they can only pass it on via mutation.
            if mother in two_genes:
                pass_prob_mother = 1 - PROBS["mutation"]
            elif mother in one_gene:
                pass_prob_mother = 0.5
            else:
                pass_prob_mother = PROBS["mutation"]

            if father in two_genes:
                pass_prob_father = 1 - PROBS["mutation"]
            elif father in one_gene:
                pass_prob_father = 0.5
            else:
                pass_prob_father = PROBS["mutation"]
        ...
        # Factor in the probability of exhibiting (or not) the trait given the gene count.
